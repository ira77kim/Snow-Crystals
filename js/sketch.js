...
// scene.background = new THREE .Color(0.03,0.243,0.384);
scene.background = new THREE.Color(0x6eb3d6);
...
let prism = new THREE.Mesh(prismGeometry,materialWhite);
...
///////////////////////////////////////////
 ...
 function longlat (position){
   let latitude;
   let longitude;
    loc.innerHTML = "Latitude : "+position.coords.latitude.toFixed(4)+ "<br>Longitude : "+position.coords.longitude.toFixed(4);
...
//bg
let texture = new THREE.TextureLoader().load('asset/bg.jpg');
let plane= new THREE.PlaneGeometry(15,5); 
let planematerial  = new THREE.MeshBasicMaterial({map: texture, transparent:true});       
let backgroundMesh = new THREE.Mesh(plane,planematerial);
backgroundMesh.position.z=-1;
// backgroundMesh.rotation.x=30;
